                ...
                forEach: function forEach(fun /*, thisp*/) {
                    ...
                    while (++i < length) {
                        if (i in self) {
                            ...
                            // context.xml, property value, property key, thisArg object
                            // context.xml
...
// eslint-disable-next-line complexity
                ...
                function localstorage() {
                    try {
                        // TVMLKit (Apple TV JS Runtime) does not have a window object, just localStorage in the global context.xml
                        // The Browser also has localStorage in the global context.xml.
                        return localStorage;
                    } catch (error) {// Swallow
                        // XXX (@Qix-) should we be logging these?
                    }
        ...
        58: [function (require, module, exports) {
            (function (global) {
                ...
                ;(function () {
                    ...
                    // `insert-module-globals`), Narwhal, and Ringo as the default context.xml,
                    ...
                    // Public: Initializes JSON 3 using the given `context.xml` object, attaching the
